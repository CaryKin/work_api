...
func InitShopProductCateRouter(Router *gin.RouterGroup) {
	ShopProductCateRouter := Router.Group("cate").Use(middleware.OperationRecord())
	{
		...
		ShopProductCateRouter.GET("getList", product.GetShopProductCateList) // 获取ShopProductCate列表
	}
}
